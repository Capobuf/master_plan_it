    ...
    <>
      ...
      <div className="space-y-6">
        ...
        <ComponentCard title="Contract register">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400">The documented <code>q</code> parameter is sent to the API. Current ContractListQuery does not apply it server-side yet, so this control will take effect when that API gap is closed.</p>
