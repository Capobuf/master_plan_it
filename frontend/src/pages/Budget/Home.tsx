...
export default function BudgetHome() {
  ...
  else if (current.data && current.preview) content = <BudgetView dataset={current.data} preview={current.preview} onRefresh={refreshBudget} tenantId={current.tenantId} />;
