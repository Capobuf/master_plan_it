...
export default function ContractTermsEditor({ terms, onChange, defaultVatRate = null, disabled = false, existingTerms = [], validationErrors = {}, onFieldChange = () => undefined }: { terms: ContractTermInput[]; onChange: (terms: ContractTermInput[]) => void; defaultVatRate?: string | null; disabled?: boolean; existingTerms?: ContractTerm[]; validationErrors?: Record<string, string>; onFieldChange?: (fields: string[]) => void }) {
