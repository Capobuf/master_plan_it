...
{
    public function __invoke(Request $request, EconomicDatasetQuery $datasetQuery, EconomicEngine $engine, TenantDashboardQuery $dashboard): Response
    {
        ...
        if(!$selected){return Inertia::render('Operational/Dashboard',$props);}
        ...
        return Inertia::render('Operational/Dashboard',$props);
    }
}
