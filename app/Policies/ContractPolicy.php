...
final class ContractPolicy
{
    ...
    {
        return $this->collection($user, 'contract.view');
    }

    public function view(User $user, Contract $contract): Response
    {
        return $this->record($user, 'contract.view', $contract);
    }

    public function create(User $user): Response
    {
        return $this->collection($user, 'contract.create');
    }

    public function update(User $user, Contract $contract): Response
    {
        return $this->record($user, 'contract.update', $contract);
    }

    public function delete(User $user, Contract $contract): Response
    {
        return $this->record($user, 'contract.delete', $contract);
    }

    public function generateOccurrence(User $user, Contract $contract): Response
    {
        return $this->record($user, 'contract.generate-occurrence', $contract);
    }

    public function suppressGeneration(User $user, Contract $contract): Response
    {
        return $this->record($user, 'contract.suppress-generation', $contract);
    }

    public function resumeGeneration(User $user, Contract $contract): Response
    {
        return $this->record($user, 'contract.resume-generation', $contract);
    }

    public function viewRevisions(User $user, Contract $contract): Response
    {
