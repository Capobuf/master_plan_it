...
| `safe_render` | Toggle [safe\_render](portal-pages.md#safe_render) |
...
For example by adding ``to your`.html`or`.md`file,`context.add\_breadcrumbs`will be set to`True` and it will automatically generate
