...
| Option | Explanation |
| --- | --- |
| Level | [Permission Level](users-and-permissions.md#permission-level) assigned to this role |
...
[Role Permissions Manager](users-and-permissions.md#role-permissions-manager).
...
to setup a **Social Login Key**. Learn more about it here.
