...
| TailAdmin browser lifecycle conflict | M | High | Alpine state and ApexCharts instance ownership during navigation or partial DOM replacement | one native TailAdmin interaction owner, explicit ApexCharts initialization/cleanup and focused Dusk coverage | UI lead | 001-005 |
