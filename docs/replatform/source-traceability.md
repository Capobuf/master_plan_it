...
| R-VAT-001 | VAT decomposition uses exact half-up decimal arithmetic and Net + VAT = Gross | `tax.py::validate_strict_vat`; C-02 | INV-VAT-001 | T003-001, T003-002, T003-010, T003-011 | `VatCalculatorTest`, `ExpenseCalculationTest` |
...
| R-DATE-001 | Single spend date xor complete period is an Expense aggregate invariant | `mpit_expense.py::_validate_row` | FR-003-050; INV-DATE-001 | T003-010, T003-011 | `CreateExpenseTest`, `UpdateExpenseTest`, `ExpenseCalculationTest` |
...
| R-MD-REV-001 | Vendor/CostCenter use allowlisted Overtrue v6 SNAPSHOT history with package actor attribution; application revision batches own correlation and only domain restore Actions may create a validated new current revision | C-05/C-12; PD-REV-001; RES-002-004/010 | FR-002-012; INV-MD-REV-001 | T002-004–T002-006, T002-010–T002-015, T002-017 | `VersioningPackageSmokeTest`, `RevisionBatchSchemaTest`, `RevisionBatchIntegrationTest`, cost-center/vendor revision tests |
