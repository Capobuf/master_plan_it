...
| T002-007–008 | `php artisan test tests/Feature/MasterData/PlanningYearTest.php tests/Feature/Migration/PlanningYearCalendarBoundaryTest.php tests/Architecture/WriteRollbackCoverageTest.php` |
| T002-009 | `php artisan test tests/Livewire/MasterData/PlanningYearResourceTest.php` |
| T002-010–011 | `php artisan test tests/Feature/MasterData/CostCenterTreeTest.php tests/Feature/MasterData/CostCenterLifecycleTest.php tests/Feature/MasterData/CostCenterRevisionTest.php tests/Architecture/WriteRollbackCoverageTest.php` |
...
| T002-013–014 | `php artisan test tests/Feature/MasterData/VendorTest.php tests/Feature/MasterData/VendorLifecycleTest.php tests/Feature/MasterData/VendorRevisionTest.php tests/Architecture/WriteRollbackCoverageTest.php` |
| T002-015 | `php artisan test tests/Livewire/MasterData/VendorResourceTest.php` |
| T002-016 | `php artisan test tests/Feature/MasterData tests/Feature/Revisions tests/Feature/Migration/PlanningYearCalendarBoundaryTest.php tests/Livewire/MasterData && composer test:static` |
