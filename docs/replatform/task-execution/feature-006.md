...
| Tasks | Command |
|---|---|
| T006-001–002 | `php artisan test tests/Feature/Migration/ImportSchemaTest.php` |
| T006-003–004 | `php artisan test tests/Feature/Migration/ImportPackageValidationTest.php` |
...
| T006-010–011 | `php artisan test tests/Feature/Portability/TenantExportPackageTest.php tests/Feature/Portability/TenantImportRoundTripTest.php tests/Feature/Portability/PortabilityExclusionTest.php` |
| T006-012 | `composer require spatie/laravel-backup:10.3.0 --with-all-dependencies --no-interaction && php artisan test tests/Feature/Operations/BackupDependencyGateTest.php tests/Feature/Operations/BackupRestoreContractTest.php` |
...
| T006-017 | `php artisan test tests/Feature/Migration tests/Feature/Portability tests/Feature/Operations tests/Feature/Deployment` plus documented review of `docs/replatform/cutover-readiness.md` |
