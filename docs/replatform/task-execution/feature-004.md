...
| T004-006 | `php artisan test tests/Livewire/Projects/ProjectOperationalPageTest.php tests/Feature/Console/PromoteDeferredProjectsCommandTest.php` |
...
| T004-009 | `php artisan test tests/Livewire/Contracts/ContractOperationalPageTest.php` |
...
| T004-015–016 | `php artisan test tests/Feature/Contracts/DeleteGeneratedExpenseTest.php tests/Livewire/Contracts/ContractOperationalPageTest.php` |
| T004-017–018 | `php artisan test tests/Feature/Contracts/ContractOccurrenceControlTest.php tests/Livewire/Contracts/ContractOperationalPageTest.php` |
