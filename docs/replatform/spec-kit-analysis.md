...
| RERUN-M-001 | RESOLVED in root/replatform phase metadata |
...
| Official `/speckit.analyze` | next after review/merge; require CRITICAL 0 and HIGH 0 |
...
- second task remediation: COMPLETE, pending review/merge;
- next `/speckit.analyze`: NEXT AFTER MERGE;
