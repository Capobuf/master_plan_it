...
| RES-002-006 | Native TailAdmin Laravel Blade page patterns | The branch has one UI stack; native TailAdmin components cover tables/forms and active selectors before any adapter is written. | Preline, Filament or custom CRUD framework |
