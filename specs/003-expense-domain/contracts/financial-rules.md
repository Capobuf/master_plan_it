...
Forms, models, SQL projections, Blade components, charts and exports cannot reimplement formulas. Expense Actions calculate persisted rows; `EconomicEngine` aggregates them.
