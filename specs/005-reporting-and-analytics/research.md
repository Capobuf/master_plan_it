...
| RES-005-006 | Dedicated React print view, no server PDF package | Product requires printing; avoids browser/container/Python/cloud dependency while keeping application UI in React. | Blade feature view, Browsershot/Gotenberg/WeasyPrint/DomPDF at launch |
