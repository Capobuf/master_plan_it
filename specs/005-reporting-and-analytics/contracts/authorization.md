...
All four roles may view, print and export only records visible to their scope. Reporting routes are read-only; no role can mutate domain data through a report endpoint.
