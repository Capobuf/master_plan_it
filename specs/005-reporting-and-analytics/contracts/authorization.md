...
- Administrator, Editor, and Viewer may read, print, and export economic reports for one tenant.
- Editor may create scenarios; Viewer may not.
- Only Administrator may view the global operational overview.
