...
| RES-004-007 | Blade/Tailwind/TailAdmin term editor and history page | Reuses the shared authenticated tenant/domain stack with the branch's single frontend stack. | Livewire/Preline, Filament as implicit owner, custom SPA/timeline package |
