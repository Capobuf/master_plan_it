...
| RES-004-007 | Operational Livewire/Blade/Preline term editor and history page under ADR-035 | Reuses the shared authenticated tenant/domain stack while keeping project/contract operations outside the administrative panel. | Filament as implicit operational owner; custom SPA/timeline package |
