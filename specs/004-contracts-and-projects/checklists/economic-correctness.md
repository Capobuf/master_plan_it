...
- [x] CHK001 Are project-stage bucket effects defined for every stage without assigning an authoritative monetary total to Project? [Completeness, Spec §FR-004-010–FR-004-012; INV-PRJ-001–INV-PRJ-004]
- [x] CHK002 Are contract term amount, VAT, billing cycle, derived end, overlap, and renewal-lineage requirements exact and mutually consistent? [Clarity, Spec §FR-004-020–FR-004-023]
- [x] CHK003 Are canonical occurrence-key components and uniqueness requirements sufficient to distinguish legitimate occurrences without inventing cost identity? [Measurability, Spec §FR-004-025–FR-004-026; INV-CON-002]
- [x] CHK004 Are generated-row create/update/suppress/resume/delete/regenerate outcomes defined for expected, user-authoritative, and exception states? [Coverage, Spec §FR-004-027–FR-004-036]
- [x] CHK005 Are generation rules consistent with one shared Expense Action boundary and the prohibition on duplicated economic formulas? [Consistency, Generation-sync contract; INV-CON-003–INV-CON-008]
