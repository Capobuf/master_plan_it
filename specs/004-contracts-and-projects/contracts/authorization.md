...
Administrator and Administrator manage projects/contracts. Editor may create/update projects and contracts where current permissions grant it, but generated-source identity and auto-renew flags remain server-owned. Viewer is read-only.
