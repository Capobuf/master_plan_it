...
- Administrator and Editor may manage same-tenant projects, contracts, stages, terms, and renewals.
- Generated source identities and history already used by generated expenses are system-controlled.
- Viewer may read, print, and export same-tenant project/contract data.
- Generation and scheduler operations require explicit same-tenant ownership.
