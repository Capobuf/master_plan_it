...
- [x] CHK001 Are keyboard order, visible focus, validation focus, destructive confirmation, and modal escape requirements defined for every shared shell pattern? [Completeness, Spec §FR-001-004, §FR-001-019, §NFR-001-A11Y-01, §NFR-001-UX-01; AC-001-11; Trace R-UI-002; runtime owned by T001-028/T001-029, T003-012 and T005-026]
...
- [x] CHK003 Are tenant-configured output language and the non-white-labelled Master Plan IT application shell consistently distinguished? [Consistency, Spec §FR-001-007; Feature 007 §FR-007-021; Q-013, Q-039]
- [x] CHK004 Are loading, empty, denied, stale-conflict, and unexpected-error presentation requirements defined with stable error references? [Coverage, Spec §NFR-001-LOG-01, §NFR-001-STATE-01; AC-001-12; Error catalogue `RESOURCE_NOT_FOUND`/`PERMISSION_DENIED`/`STALE_VERSION`/`UNEXPECTED_ERROR`; Trace R-UI-002; runtime owned by T001-028/T001-029, T003-009/T003-012, T005-006/T005-007 and T005-026]
